...
import 'ecommerce_home_drawer_widget_controller.dart';
import 'ecommerce_home_drawer_widget_cubit.dart';

import 'package:basic/app/core/widgets/base_stateless_widget.dart';

class EcommerceHomeDrawerWidget
    extends BaseStatelessWidget<
        EcommerceHomeDrawerWidgetController,
        EcommerceHomeDrawerWidgetCubit,
        EcommerceHomeDrawerWidgetState> {

  EcommerceHomeDrawerWidget({Key? key, super.controller, super.onStateChanged})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider<EcommerceHomeDrawerWidgetCubit>(
  ...
  @override
  EcommerceHomeDrawerWidgetCubit createCubitAndAssignToController(
      BuildContext context) {
    EcommerceHomeDrawerWidgetCubit cubit = EcommerceHomeDrawerWidgetCubit(
        context: context);
